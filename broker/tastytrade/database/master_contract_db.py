...
def get_scrip_groups():
    """Fetch available scrip groups from tastytrade API"""
...
def format_symbol(row, id_format):
    """Format symbol based on tastytrade's idFormat patterns"""
    try:
...
def master_contract_download():
    """Download and process tastytrade scrip data"""
    logger.info("Starting tastytrade Master Contract Download")
