...
validate_broker() {
    local broker=$1
    local valid_brokers="fivepaisa,fivepaisaxts,aliceblue,angel,compositedge,definedge,deltaexchange,dhan,dhan_sandbox,firstock,flattrade,fyers,groww,ibulls,iifl,indmoney,jainamxts,kotak,motilal,mstock,nubra,paytm,pocketful,rmoney,samco,shoonya,tastytrade,upstox,wisdom,zebu,zerodha"
...
while true; do
    ...
    echo "rmoney, samco, shoonya, tastytrade, upstox, wisdom, zebu, zerodha,"
    echo ""
